...
module.exports = {
	...
	// `zenburn`) and can be extended by installing more themes. Read more about
	// how to manage them [here](https://thelounge.github.io/docs/plugins/themes.html).
	//
